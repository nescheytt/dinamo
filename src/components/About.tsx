  ...
  return (
    <section className="w-full min-h-screen flex flex-col items-center justify-center gap-10 md:gap-20">
      <div className="max-w-xl">
        ...
        <m.p initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0, transition: { delay: .75, duration: .75 } }} viewport={{ once: true }} className="text-xl text-center font-light text-zinc-400">
          We take care of making your user interface shine with modern designs, clean code and a fully optimized application.
        </m.p>
      </div>

      <m.div initial={{ opacity: 0 }} whileInView={{ opacity: 1, transition: { delay: 1.50, duration: 1.50 } }} viewport={{ once: true }} className="max-w-6xl flex flex-col md:flex-row gap-5 md:gap-10">
